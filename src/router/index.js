...
export const asyncRouterMap = [
  ...
  
  {
    ...
    children: [
      { path: 'creditrequest', component: _import('work/creditrequest/creditrequest'), name: 'creditrequest', meta: { title: 'creditrequest', icon: 'table' }},
      { path: 'inquire', component: _import('work/inquire/inquire'), name: 'inquire', meta: { title: 'inquire', icon: 'table' }}
    ]
  },
