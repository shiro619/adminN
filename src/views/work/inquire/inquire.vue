  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
    	<el-col :span="24">
    		<el-row :gutter="10">
	    		<el-col :span="6">
			      <el-tooltip class="item" effect="dark" content="申请编号" placement="top">
			      	<el-form>
				        <el-form-item label-width="75px" label="申请编号:" class="postInfo-container-item" style="width: 100%;">
				          <el-input prefix-icon="el-icon-search" placeholder="申请编号">
				          </el-input>
				        </el-form-item>
			        </el-form>
			      </el-tooltip>
			      ...
			      <el-tooltip class="item" effect="dark" content="客户姓名" placement="top">
			      	<el-form>
				        <el-form-item label-width="75px" label="客户姓名:" class="postInfo-container-item" style="width: 100%;">
				          <el-input prefix-icon="el-icon-search" placeholder="客户姓名">
				          </el-input>
				        </el-form-item>
			        </el-form>
			      </el-tooltip>
		      ...
		      <el-col :span="8">
			      <el-tooltip class="item" effect="dark" content="车辆类型" placement="top">
			      	<el-form>
				        <el-form-item label-width="75px" label="车辆类型:" class="postInfo-container-item" style="width: 100%;">
				          <el-radio v-model="cartype" label="1">全部</el-radio>
									<el-radio v-model="cartype" label="2">新车</el-radio>
									<el-radio v-model="cartype" label="3">二手车</el-radio>
				        </el-form-item>
			        </el-form>
			      </el-tooltip>
		      </el-col>
    	...
    	<el-col :span="24">
    		<el-row :gutter="10">
	    		<el-col :span="12">
			      <el-tooltip class="item" effect="dark" content="进件时间" placement="top">
			      	<el-form>
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row
      style="width: 100%">
      <el-table-column align="center" label="申请编号" width="65">
      ...
      <el-table-column width="110px" v-if='showAuditor' align="center" label="车辆类型">
        <template slot-scope="scope">
...
import { listInquire } from '@/api/listinfo'
...
//    listInquire(this.listData).then(response => {
...
//        listInquire(this.listdata).then(() => {
//          this.list.unshift(this.listdata)
